...
% The BC structure is used to setup boundary conditions and for the program
bc{1}.NumS = 1;
% bc{1}.s(1) sets up planewave source
...
Plot.y0 = round(y0/dx);
% These setup the different boundary conditions
% When type is changed to e the BC becomes it generates an e field. when
% set to a the boundary is absorbing
bc{1}.xm.type = 'e';
bc{1}.xp.type = 'a';
bc{1}.ym.type = 'a';
bc{1}.yp.type = 'a';
